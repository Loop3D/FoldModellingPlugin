...
from FoldOptLib.datatypes import InterpolationConstraints, ConstraintType 
...
def builder():
    ...
    tangent_constraints = numpy.array([[1, 2, 3, 0., 0, 0.99, 7]], dtype=float)
...
def test_evaluate_scalar_value(builder):
    ...
    locations = numpy.array([[0.1, 0.2, 0.3],
                             [0.2, 0.3, 0.1]], 
                             dtype=float)
